...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/order/invoice/{id}', 'App\Http\Controllers\OrderController@invoice')->name('orders.invoice');
    Route::post('/product/comment', 'App\Http\Controllers\ProductController@comment')->name('products.comment');
});

Route::middleware(['userisadmin', 'auth:sanctum', 'verified'])->group(function () {
